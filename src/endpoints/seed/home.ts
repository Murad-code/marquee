...
export const home: (args: HomeArgs) => RequiredDataFromCollectionSlug<'pages'> = ({
  ...
  return {
              ...
              children: [
                {
                  ...
                  mode: 'normal',
                  style: '',
                  text: 'Elevating events with premium marquees and exceptional service. From intimate gatherings to grand celebrations, we provide the perfect marquee solution for your special occasion.',
                  version: 1,
                },
              ],
              direction: 'ltr',
    ...
    meta: {
      ...
      image: heroImage.id,
              title: 'Herts Marquee - Elevating Events',
    },
    title: 'Home',
  }
}
