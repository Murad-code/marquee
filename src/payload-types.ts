...
export interface Config {
  ...
  collectionsSelect: {
    ...
    marquees: MarqueesSelect<false> | MarqueesSelect<true>;
...
export interface Availability {
  ...
  /**
   * Leave empty to use marquee base price
   */
  price?: number | null;
  notes?: string | null;
  updatedAt: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "marquees_select".
 */
export interface MarqueesSelect<T extends boolean = true> {
  name?: T;
  description?: T;
  images?:
    | T
